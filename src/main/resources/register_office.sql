...
INSERT INTO ro_person (sex, first_name, last_name, patronymic, date_birth) VALUES
(1, 'Olena', 'Vasulushuna', 'Sergiivna', '1998-03-24'),
(2, 'Oleh', 'Vasulushun', 'Petrovuch', '1997-10-16'),
(2, 'Pavlo', 'Vasulushun', 'Olehovuch', '2018-10-21');

INSERT INTO ro_passport (person_id, seria, number, date_issue, issue_department) VALUES
(1, '40000', '123456', '2018-04-10', 'Department Passport');

INSERT INTO ro_birth_certificate (number_certificate, date_issue, person_id, father_id, mother_id) VALUES
('123 Birth', '2018-01-01', 3, 2, 1);